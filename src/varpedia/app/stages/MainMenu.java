...
public class MainMenu extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		_wikiButton.setTooltip(new Tooltip("Search Wikipedia for specified term"));
		...
		_creationButton.setTooltip(new Tooltip("Refresh creation list"));
		...
		_quizButton.setTooltip(new Tooltip("Generate a quiz using your saved Creations"));
		_quizButton.setOnAction((e) -> {
			
			List<String> creations = CreationUtils.getCreationNames("");
			if (creations.isEmpty()) {  // don't create quiz if no creations exist
				
				String contentText = "Error: no creations exist - please create at least one creation before generating a quiz.";
				AlertDialog alertDialog = new AlertDialog(AlertType.ERROR, "No creations exist", "No creations exist", contentText);
		...
		quizButtonLayout.getChildren().setAll(spacer, _quizButton);
		...
		// trying to make media view (MediaPlayerComponent) expand to fit remaining space without this container was buggy,
		// hence this solution.
		...
		_wikiButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			@Override public void handle(ActionEvent event) {
				...
				String searchTerm = _wikiSearch.getText().toLowerCase();  // case insensitive
				...
				wikiTask.setOnSucceeded((e) -> {
					...
					wikiCreationWindow.show();
					wikiCreationWindow.setMinWidth(wikiCreationWindow.getWidth());
					wikiCreationWindow.setMinHeight(wikiCreationWindow.getHeight());
	...
	public void updateCreationList() {
		...
		_creationListView.setItems(FXCollections.observableArrayList(CreationUtils.getCreationNames(keyword)));
	...
	class CreationCell extends ListCell<String>{
		...
		public CreationCell() {
			...
			deleteButton.setTooltip(new Tooltip("Delete this Creation"));
			...
			playButton.setTooltip(new Tooltip("Play this Creation"));

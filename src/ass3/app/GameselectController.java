...
public class GameselectController implements Initializable{
	...
	public void ClickCheck(ActionEvent e) throws IOException{
		if((vediotwo.getValue() != null) && (vedioone.getValue().toString()).equals(answer1)) {
			this.one.setText("Correct Answer: " + answer1+ "\n Your answer is correct");
		}else {
			this.one.setText("Correct Answer: " + answer1+ "\n Your answer is wrong");
		}
		
		if((vediotwo.getValue() != null)&&(vediotwo.getValue().toString()).equals(answer2)){
			this.two.setText("Correct Answer: " + answer2+ "\n Your answer is correct");
		}else {
			this.two.setText("Correct Answer: " + answer2+ "\n Your answer is wrong");
		}
		if((vediothree.getValue() != null) && (vediothree.getValue().toString()).equals(answer3)){
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		try {
			...
			vedioone.getItems().addAll(answer2,answer1,answer3);
			vediotwo.getItems().addAll(answer1,answer3,answer2);
			vediothree.getItems().addAll(answer3,answer1,answer2);
